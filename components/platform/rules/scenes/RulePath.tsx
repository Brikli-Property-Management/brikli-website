...
export function RulePath({ isActive, reducedMotion }: PlatformSceneProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-0 flex-1 flex-col items-center justify-start gap-1 pt-6">
      ...
      <div
        data-result
        data-reveal
        className="mb-2 mt-3 shrink-0 rounded-md border px-5 py-2 text-sm font-semibold"
